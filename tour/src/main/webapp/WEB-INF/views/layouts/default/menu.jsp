...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item">
				<a class="nav-link"	href="${contextPath}/board/list"> 
					<i class="fas fa-calendar-alt"></i> 게시판</a></li>
		...
		<ul class="navbar-nav">
			<c:if test="${empty USER}">
				<li class="nav-item">
					<a class="nav-link" href="${contextPath}/join"> 
			...
			<c:if test="${not empty USER}">
				...
				<li class="nav-item">
					<a class="nav-link" href="${contextPath}/member/profile/view"> 
